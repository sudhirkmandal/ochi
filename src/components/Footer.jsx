...
function Footer() {
  ...
  return (
    <div className="footer w-full h-screen bg-zinc-900 p-10 flex gap-5">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <div className="elem overflow-hidden">
            <h1 className="text-[6vw] tracking-tight  font-[700] -mb-1 uppercase leading-none">
              Eye-
            </h1>
          </div>
          <div className="elem overflow-hidden">
      ...
      <div className="w-1/2">
        <div className="elem2 overflow-hidden">
          <h1 className="text-[6vw] tracking-tight font-[700] uppercase ">
            PRESENTATIONS
          </h1>
        </div>
        <div className="dets font-['gilroy'] mt-10">
